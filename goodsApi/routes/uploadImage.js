...
let upload = multer({dest:"C:\\Users\\fs1688\\Desktop\\node\\test\\shoppingsystem\\src\\assets",limits:{fileSize:1024*1024*20}})
  router.post('/uploadImage',upload.single('imgfile'),function(req,res){
